...
export default function Reset_Password_Client(props:any){
    const router = useRouter()
const [isLoading,setIsLoading] = useState(false)
const [displayError,setDisplayError] = useState(false)
const initialValues: MyResetFormValues = {password:'',confirmPassword:''};
            ...
            <label htmlFor='password' className="block mb-2 text-sm font-medium text-gray-900 ">Password</label>
                  ...
                  
                         {
                          isLoading ? (
                            ...
                            <button type='submit' className='w-full text-white bg-black hover:bg-[#686868] focus:ring-4 focus:outline-none font-medium rounded-lg text-sm px-5 py-2.5'>Reset password</button>
                          )
                         }
            </Form>
        )}
