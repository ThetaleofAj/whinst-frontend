          ...
          />
            ...
            <div className="p-4 md:p-3 flex justify-center items-center break-words">
                <p className="text-gray-500 break-words w-full text-center">
                    {`https://whinst/catalog_viewer/${catalog_name}/${link}`}
                </p>
            </div>
            ...
            <div className="flex items-center justify-center space-x-10 p-4 md:p-4 border-t border-gray-200 rounded-b ">
                ...
                <div className='flex flex-col items-center'>
                <button onClick={()=>navigator.clipboard.writeText(`https://whinst/catalog_viewer/${catalog_name}/${link}`)}>
                ...
                <div className='flex flex-col items-center'>
                    ...
                    <FacebookShareButton url={`https://whinst/catalog_viewer/${catalog_name}/${link}`}>
            <BsFacebook size={23}/>
           </FacebookShareButton>
           <TwitterShareButton url={`https://whinst/catalog_viewer/${catalog_name}/${link}`}>
            <BsTwitterX size={23}/>
           </TwitterShareButton>
           <WhatsappShareButton url={`https://whinst/catalog_viewer/${catalog_name}/${link}`}>
            <BsWhatsapp size={23}/>
          </WhatsappShareButton>
                    </div>
                    <p>Share</p>
