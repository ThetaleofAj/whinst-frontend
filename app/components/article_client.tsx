...
<div className="prose">
    ...
    <a href="/" className="mt-3 inline-flex items-center px-3 py-2 text-sm font-medium text-center font-bold text-white bg-[#ffb31f] rounded-lg focus:ring-4 focus:outline-none focus:ring-blue-300 ">
